...
genrateChatRoomHtml = (data) => {
    var unreadCounter = (data.unread_msg_cnt > 0)? 'unread':''
        ...
        userImage = (data.doc_file_name) ? aws_url + data.bucket_name + '/' + data.doc_file_name : '/static/admin/images/no-image.jpg';
...
genrateConversationHtml = (data) => {
    ...
    var userImage = (data.image_name) ? aws_url + data.bucket_name + '/' + data.image_name : '/static/admin/images/no-image.jpg';
